...
const HomeCloseBoard = () => {
  ...
  const boardCloseDataFilterSearch = closeBoardData.filter((boardData) => {
    if (search === '') {
      return boardData
    } else {
    ...
    <div onKeyDown={handleKeyDown} tabIndex={100 as number}>
      ...
      <GeneralContentContainer>
        ...
        <MidContainer isDetailPage={false}>
          {
            Array.isArray(boardCloseDataFilterSearch) && !boardCloseDataFilterSearch.length ?
              (
                <MidContentContainer>
              ...
              (
                <MidContentContainer>
                  ...
                  <MidContentCardContainer>
                    {boardCloseDataFilterSearch.map((board) => (
