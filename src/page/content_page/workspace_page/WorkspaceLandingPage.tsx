...
const WorkspaceLandingPage = () => {
    ...
    const [invitePopupShow, setInvitePopupShow] = useState(true)
        ...
        <div>
            ...
            <GeneralContentContainer>
                ...
                <MidContainer isDetailPage={false}>
                    <MidContentContainer>
                        <MidContentTitle titleName={"Welcome To [ " + workspaceContext.workspace.workspaceTitle + " ] Workspace "} data={false}></MidContentTitle>
                    </MidContentContainer>
                </MidContainer>
            </GeneralContentContainer>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>Invite Your Team</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container>
                        {
